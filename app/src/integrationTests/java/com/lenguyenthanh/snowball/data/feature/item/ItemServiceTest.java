...
public class ItemServiceTest {
  ...
  private final String response = "[\n"
      + "  {\n"
      + "    \"id\": \"1\",\n"
      + "    \"description\": \"If there's only one player who deserves that nickname, O Fenomeno, "
      + "it's him. He's a phenomenon.\",\n"
      + "    \"title\": \"Ronaldo\",\n"
      + "    \"thumbnail\": \"https://image.freepik.com/free-photo/ronaldo---football-player-legends"
      + "_26-638.jpg\"\n"
      + "  },\n"
      + "  {\n"
      + "    \"id\": \"2\",\n"
      + "    \"description\": \"Mark my words Gerrard is the greatest player to have played for #lfc"
      + " sad sad day for everyone connected with the club.\",\n"
      + "    \"title\": \"Gerrard\",\n"
      + "    \"thumbnail\": \"https://scontent-hkg3-1.xx.fbcdn.net/hphotos-xap1/v/t1.0-9/10671345_10"
      + "202881746756109_7243997333740624908_n.jpg?oh=555f96c811e2ce69f5dee2ccfb8191fb&oe=57BD4908\"\n"
      + "  },\n"
      + "  {\n"
      + "    \"id\": \"3\",\n"
      + "    \"description\": \"I don’t think anyone ever looks forward to playing against Luis Suar"
      + "ez, he is a fantastic talent and a very dangerous player. He is a fantastic team mate, proba"
      + "bly the best player I have played with.\",\n"
      + "    \"title\": \"Luis Suarez\",\n"
      + "    \"thumbnail\": \"http://i.dailymail.co.uk/i/pix/2014/06/27/article-2671421-0783B5E70000"
      + "0514-407_634x488.jpg\"\n"
      + "  }\n"
      + "]";
